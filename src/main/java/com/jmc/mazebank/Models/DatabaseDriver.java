...
public class DatabaseDriver {
	...
	public DatabaseDriver() {
		try {
			this.conn = DriverManager.getConnection("jdbc:sqlite:highbank.db");
	...
	public void Sv2Ch(String pAddress, double minus) {
		Statement statement;
		ResultSet resultSet;
		try {
			statement = this.conn.createStatement();
			...
			newBalance = resultSet.getDouble("Balance") - minus;
	...
	public void Ch2Sv(String pAddress, double minus) {
		Statement statement;
		ResultSet resultSet;
		try {
			statement = this.conn.createStatement();
